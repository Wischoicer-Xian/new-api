...
// RecordRelaySample preserves the fork-side request-boundary API for callers
// that already classified the relay outcome. New code should prefer
// RecordRelayResult so business rejections and cancellations are filtered in
// one place.

...
// filterChannelsByRequestPathAndModel remains available for the fork's
// operation-specific cache checks and for its regression tests. Production
// selection uses ChannelSatisfiesFilters below, which applies the same
// async-image guard through model/channel_constraint.go.

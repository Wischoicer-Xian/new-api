...
// AdminGenerateAccessToken preserves the fork's administrative token issuance
// endpoint. Self-service token issuance is implemented in access_token.go so it
// can enforce the upstream security-proof flow.

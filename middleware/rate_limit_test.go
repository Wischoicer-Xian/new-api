...
func TestRedisFailurePolicies(t *testing.T) {
	...
	assert.Equal(t, http.StatusTooManyRequests, performRateLimitRequest(router, "/ip", "192.0.2.60:54321").Code)
	...
	assert.Equal(t, http.StatusTooManyRequests, performRateLimitRequest(router, "/user", "192.0.2.99:54321").Code)
